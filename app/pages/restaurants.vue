  ...
  <div class="flex flex-col h-full w-full">
    ...
    <main class="flex-1 relative overflow-hidden">
      ...
      <MapRouteBadge
        ...
        :visible="true"
        class="absolute bottom-32 left-4 z-10"
      />
      ...
      >
        <button
          ...
          class="absolute bottom-32 right-4 z-10 bg-white shadow-lg rounded-full p-3 border border-border hover:bg-muted transition-colors"
